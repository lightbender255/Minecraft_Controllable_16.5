...
some small patches to the vanilla MCP source code, giving you access
to some of the data and functions you need to build a successful mod.

Note also that the patches are built against MCP source code that hasn't been renamed (aka
